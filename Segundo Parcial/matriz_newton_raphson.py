...
El método Newton-Raphson es un metodó que permite obtener aproximaciones a las soluciones
de un sistema de ecuaciones no lineales. Para que este metodo no diverga se debe asegurar que la diagonal
del sistema que va desde la esquina superior a la izquiera a la inferior derecha tiene el coeficiente más grande en
