"""
Solucion de Ecuaciones lineales por matriz inversa.

Podemos tener la solución aun sistema de ecuaciones lineales con el sigueinte ecuacion:
A * X = B
A^-1 * A * X = A^-1 * B 

X = A^-1 * B 

El problema de este metódo es que no todas las matrices tienen inversa y 
calcular las requeridas es muy complejo y tedioso. Gracias al poder computacional de hoy en dia es priacticamente
sencillo resolver los sistemas por este método.
"""
